...
<fieldset className="rating">
    ...
    <input type="radio" id="star4half" name="rating" value="4 and a half" /><label htmlFor="true" className="half" for="star4half" title="Pretty good - 4.5 stars"></label>
    <input type="radio" id="star4" name="rating" value="4" /><label htmlFor="true" className = "full" for="star4" title="Pretty good - 4 stars"></label>
    ...
    <input type="radio" id="star3" name="rating" value="3" /><label htmlFor="true" className = "full" for="star3" title="Meh - 3 stars"></label>
    ...
    <input type="radio" id="star2" name="rating" value="2" /><label htmlFor="true" className = "full" for="star2" title="Kinda bad - 2 stars"></label>
    ...
    <input type="radio" id="star1" name="rating" value="1" /><label htmlFor="true" className = "full" for="star1" title="Sucks big time - 1 star"></label>
